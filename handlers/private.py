...
async def start(_, message: Message):
                ...
                caption=(f"""**Merhaba {message.from_user.mention} 🎵\nBen {bot}!\nSesli sohbetlerde müzik çalabilen botum. Ban yetkisiz, Ses yönetimi yetkisi verip, Asistanı gruba ekleyiniz.\n\nDüzen Tasarım [TEXNOTEAM MUZIK 🎙️](https://t.me/texnoteamm).**"""),
         reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ Grubuna Ekle ❱ ➕", url=f"https://t.me/teammusicixBot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/teammusiqi"
                    ),
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/internetschat"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Resmi Kanal 🇹🇷", url=f"https://t.me/texnoteamm"
                    )
                ]
      ...
      reply_markup=InlineKeyboardMarkup(
             [
                 [
                     ...
                     InlineKeyboardButton(
                         "⚙ Sahib" , url="https://t.me/TTteamabasof")
                 ]
             ]
         )
    )
